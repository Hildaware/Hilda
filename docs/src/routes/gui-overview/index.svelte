<div class="bg-gray-100">
    <div class="flex w-full">
        <div class="w-2/3 px-4">
            ...
            <ul class="basic-list">
                <li>
                    <strong>1.</strong> Unlocks Priority Set Windows. This allows for dragging the windows around the screen
                </li>
                <li>
                    ...
                    <ul class="inner-list">
                        ...
                        <li>
                            Changelog - Opens the Changelog Window. This displays the latest changes to the plugin
                        </li>
                        <li>
                            Discord - Opens Discord to <a target="_blank" href="https://discord.gg/JzrMWYT7ay">Hilda's Server</a>
                        </li>
                        <li>
                            Donate - Opens a browser to <a target="_blank" href="https://ko-fi.com/sel352">Our Ko-Fi page</a>. This plugin took a lot to develop and maintain. Please donate!
                        </li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ul class="inner-list">
                        ...
                        <li>
                            Import Priority Set - Imports a Priority Set from a base64 encoded string
                        </li>
                    </ul>
                </li>
                <li>
                    <strong>5.</strong> Priority Sets
                    <ul class="ml-6 basic-list">
                        ...
                        <li>
                            ...
                            <ul class="inner-list">
                                ...
                                <li>
                                    Export Set - Copies the set in a base64 encoded string to your clipboard
                                </li>
                            </ul>
                        </li>
                        <li>
                            <strong>8.</strong> Priority Set Overview - Displays the priorities in the set (It just looks cool)
                        </li>
                        <li>
                        ...
                        <li>
                            <strong>10.</strong> Save - Any modification needs to be saved. Text will display if a set requires saving.
                        </li>
                    </ul>
                </li>
            </ul>
